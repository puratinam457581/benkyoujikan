...
// Service Worker の状態を画面下部に知らせる帯。
//   - 新しいバージョンがある → 「更新する」で読み込み直して切り替え
//   - 初回キャッシュが済んだ → オフラインでも使えることを一度だけ知らせる
export default function PwaBanner() {
  ...
  if (needRefresh) {
    return (
      <Banner>
        <RefreshCw size={16} strokeWidth={1.6} className="shrink-0 text-cyan" />
  ...
  if (offlineReady) {
    return (
      <Banner>
        <WifiOff size={16} strokeWidth={1.6} className="shrink-0 text-cyan" />
